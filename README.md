...
- Người dùng chọn độc lập English/Tiếng Việt và VND/USD; giao diện, AI Coach và email dùng cùng tùy chọn.
- Dữ liệu tiền luôn lưu bằng VND để bảo toàn lịch sử; USD chỉ là lớp nhập/hiển thị theo tỷ giá cấu hình.
...
| `USD_VND_RATE` | `25000` | Số VND quy đổi cho 1 USD khi người dùng chọn hiển thị USD; nên cập nhật theo chính sách triển khai |
